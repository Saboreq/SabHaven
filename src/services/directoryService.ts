...
import { formatBytes, hasUnsafePathCharacter, sanitizeFileName } from '../lib/format';
...
function normalizeFolderName(name: string) {
  ...
  if (!normalizedName || normalizedName.length > 120 || hasUnsafePathCharacter(normalizedName)) {
