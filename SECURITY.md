...
SabHaven is a privacy-focused, invite-only file portal. Security reports are welcome and must not be opened as public issues.

Use [GitHub private vulnerability reporting](https://github.com/Saboreq/SabHaven/security/advisories/new) when possible. If that is unavailable, email **contact@saboreq.xyz**.
